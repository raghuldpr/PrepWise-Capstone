...
**PrepWise** is a full-stack, enterprise-grade AI-powered interview preparation platform. It provides candidates with real-time simulated technical interviews, resume parsing, customized feedback, and AI-generated question banks powered by Google Gemini AI.
...
graph TD
    ...
    Backend -->|REST API| Gemini[Google Gemini AI API]
...
cp .env.example .env
```
*(Optional: Add your `GEMINI_API_KEY` inside `.env` to enable live AI feedback)*
