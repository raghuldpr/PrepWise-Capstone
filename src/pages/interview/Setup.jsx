...
export default function Setup() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 font-body">
      ...
      {/* Error Alert */}
      {errorMessage && (
        <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/30 text-red-600 dark:text-red-400 flex items-center justify-between gap-3 text-sm">
