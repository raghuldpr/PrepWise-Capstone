  ...
  if (loading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-4 text-white">
        <div className="w-12 h-12 rounded-2xl bg-[#C85232]/15 border border-[#C85232] flex items-center justify-center text-[#C85232] mb-3 animate-pulse">
          <BarChart2 size={24} />
        </div>
        <p className="text-xs text-neutral-400 font-mono">Loading interview history & performance trend...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 py-4 px-2 sm:px-4 font-body text-[#E4E4E7]">
      ...
      {filteredHistory.length === 0 && (
        <div className="bg-[#161619] border border-neutral-800/90 rounded-2xl p-10 text-center space-y-4 shadow-xl">
          <div className="w-16 h-16 rounded-2xl bg-[#C85232]/10 border border-[#C85232]/30 flex items-center justify-center text-[#C85232] mx-auto">
            <BarChart2 size={32} />
          </div>
          ...
          <div className="pt-2">
            {searchQuery || filterType !== 'ALL' ? (
              ...
              <button
                onClick={() => navigate('/interview/setup/role')}
                className="px-6 py-2.5 rounded-xl text-xs font-bold bg-[#C85232] hover:bg-[#b04328] text-white shadow-lg transition-all inline-flex items-center gap-2"
              >
                <Sparkles size={16} />
